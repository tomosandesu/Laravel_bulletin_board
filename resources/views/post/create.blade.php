        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light py-4">
            ...
            @csrf
                <div class="mb-3 mt-4">
                    ...
                    <input name="title" type="text" class="form-control" id="title" placeholder="20文字以内で入力してください。" value="{{ old('title') }}">
                    @error('title')
                ...
                <div class="mb-3">
                    ...
                    <textarea name="comment" class="form-control" id="comment" rows="3" placeholder="400文字以内で入力してください。">{{ old('comment') }}</textarea>
                    @error('comment')
                    <div class="alert alert-danger" role="alert">
                        {{ $message }}
                    </div>    
